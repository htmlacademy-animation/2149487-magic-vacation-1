...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    if (this.screenElements[this.activeScreen].classList.contains(`screen--prizes`)) {
      ...
      document.querySelector(`.fill-block`).classList.remove(`active`);
      this.screenElements.forEach((screen) => {
        screen.classList.add(`screen--hidden`);
        screen.classList.remove(`active`);
      });
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  function setBodyClasslist(classname) {
    if (prevClass) {
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              setBodyClasslist(`story-theme--pink`);
              ...
              setBodyClasslist(`story-theme--blue`);
              ...
              setBodyClasslist(`story-theme--light`);
            } else if (storySlider.activeIndex === 6 || storySlider.activeIndex === 7) {
              sliderContainer.style.backgroundImage = `url("img/slide4.jpg"), linear-gradient(180deg, rgba(45, 39, 63, 0) 0%, #2F2A42 16.85%)`;
              setBodyClasslist(`story-theme--violet`);
            }
          },
          resize: () => {
            storySlider.update();
